...
[development contributing guide](https://rstd.io/tidy-contrib) and [code review
principles](https://code-review.tidyverse.org/) before submitting a substantial
contribution.
...
write a unit test, if needed. See our guide on [how to create a great
...
Please note that the **tidyterra** project is released with a [Contributor Code
