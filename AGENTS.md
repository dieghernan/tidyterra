...
- `review-comments`: load `.github/agents/review-comments.agent.md` together
  with `.github/skills/proofread-comments/SKILL.md`.
- `review-docs`: load `.github/agents/review-docs.agent.md` together with
  `.github/skills/proofread-docs/SKILL.md`.
- `proofread-comments`: load `.github/skills/proofread-comments/SKILL.md`.
- `proofread-docs`: load `.github/skills/proofread-docs/SKILL.md`.

Treat `.github/agents/` and `.github/skills/` as the canonical, portable
definitions for this package. They are intended to be shared across packages
with the same AI documentation-review setup, so avoid hard-coded local paths
