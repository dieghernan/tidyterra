...
```{r example-temp, fig.alt="Average temperature in Castille and Leon, Spain"}
library(tidyterra)
library(terra)
...
```{r example-tile, fig.alt="Example: Plotting a tile in tidyterra"}
...
```{r hypso, fig.asp=0.65, fig.alt="Hypsometric map of Asia"}
