...
- `SpatRaster`: For `SpatRaster` objects, the implementation differs because
  methods can apply to layers or cells. **tidyterra**'s overall approach is to
  treat the layers as columns of a tibble and the cells as rows (i.e.
