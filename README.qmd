...
- `SpatRaster`: methods can be applied to layers or
  cells. **tidyterra**'s overall approach is to treat the layers as columns of a
  tibble and the cells as rows (i.e. `select(SpatRaster, 1)` selects the first
