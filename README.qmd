...
[**tidyverse**](https://tidyverse.org/packages/) methods for `SpatRaster` and
...
**tidyverse** methods implemented in **tidyterra** work differently depending on
...
**tidyverse** methods and verbs. This approach has a **performance cost**.
...
As a rule of thumb, if your raster has fewer than 10,000,000 data slots (i.e.
`terra::ncell(your_rast) * terra::nlyr(your_rast) < 1e7`), **tidyterra** is a
good fit.
...
**tidyterra** provides scales for plotting maps with hypsometric tints and
**ggplot2**:
