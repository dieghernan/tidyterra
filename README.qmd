...
- `SpatRaster`: The implementation for `SpatRaster` objects differs because
  methods can be applied to layers or cells. **tidyterra**'s overall approach is
  to treat the layers as columns of a tibble and the cells as rows (i.e.
