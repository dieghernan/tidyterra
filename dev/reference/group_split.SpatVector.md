...
- It does not name the elements of the list based on the grouping as
  ...
  Instead, use
  [`group_keys.SpatVector()`](https://dieghernan.github.io/tidyterra/dev/reference/group_data.SpatVector.md)
...
[`nest(.by =)`](https://dieghernan.github.io/tidyterra/dev/reference/nest.SpatVector.md).
