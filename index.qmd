...
[**ggplot2**](https://ggplot2.tidyverse.org/) geoms for plotting those objects.
...
If you frequently use **terra** or work with large raster files, **terra** is
usually much faster. Whenever possible, each **tidyterra** function refers to
its equivalent on **terra**.
...
cat(
  paste0(
    '<img src="',
    img_url,
    '" alt="Example of plotting a tile in tidyterra"',
    ' width="100%" />'
  )
)
```

**tidyterra** provides scales for plotting hypsometric maps with **ggplot2**:
