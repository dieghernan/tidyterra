...
base_url <- ifelse(is_dev, "https://dieghernan.github.io/tidyterra/dev",
...
cat(
  paste0(
    '<img src="', img_url, '" alt="Average temperature in ',
...
cat(
  paste0(
    '<img src="', img_url, '" alt="Variation of temperature in ',
    'Castille and Leon, Spain" width="100%" />'
  )
)
```
...
cat(
  paste0(
    '<img src="', img_url, '" alt="Example: Plotting a tile in tidyterra"',
    ' width="100%" />'
  )
)
```
...
cat(
  paste0(
    '<img src="', img_url, '" alt="Hypsometric map of Asia"',
    ' width="100%" />'
  )
)
```
...
cat(
  paste0(
    '<img src="', img_url, '" alt="A SpatVector plotted with tidyterra"',
    ' width="100%" />'
  )
)
```
