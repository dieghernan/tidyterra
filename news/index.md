...
- This release focuses heavily on `SpatVector` objects. The improvements
  ...
  - New methods for `SpatVector`:
    ...
    - [`group_by.SpatVector()`](https://dieghernan.github.io/tidyterra/reference/group-by.SpatVector.md),[`ungroup.SpatVector()`](https://dieghernan.github.io/tidyterra/reference/group-by.SpatVector.md)
