...
test_that("Discrete scale tint", {
  ...
  p3 <- p + scale_fill_cross_blended_tint_d(alpha = 0.9)
...
test_that("Continous scale tint", {
  ...
  # Alpha
  expect_snapshot(p + scale_fill_cross_blended_tint_c(alpha = -1), error = TRUE)

  p3 <- p + scale_fill_cross_blended_tint_c(alpha = 0.9)
...
test_that("Discrete scale col tint", {
  ...
  p3 <- p + scale_colour_cross_blended_tint_d(alpha = 0.9)
...
test_that("Continous scale col tint", {
  ...
  p3 <- p + scale_colour_cross_blended_tint_c(alpha = 0.9)
