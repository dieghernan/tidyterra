test_that("Discrete scale", {
  ...
  # Alpha
  expect_error(p + scale_colour_cross_blended_d(alpha = -1),
  ...
  expect_error(p + scale_colour_cross_blended_d(direction = 0.5),
...
test_that("Discrete scale tint", {
  ...
  expect_error(p + scale_colour_cross_blended_tint_d(alpha = -1))
  expect_error(p + scale_colour_cross_blended_tint_d(direction = -12))
...
test_that("Continous scale", {
  ...
  # Alpha
  expect_error(p + scale_colour_cross_blended_c(alpha = -1),
    regexp = "alpha level -1 not in"
  )
  ...
  # Reverse also with alpha
  expect_error(p + scale_colour_cross_blended_c(direction = 0.5),
    regexp = "must be 1 or -1"
  )
...
test_that("Continous scale tint", {
  ...
  # Use tint option
  expect_error(p + scale_colour_cross_blended_tint_c(palette = "x"))
  expect_error(p + scale_colour_cross_blended_tint_c(alpha = -1))
  expect_error(p + scale_colour_cross_blended_tint_c(direction = -12))
...
test_that("Breaking scale", {
  ...
  # Alpha
  expect_error(p_init + scale_color_cross_blended_b(alpha = -1),
    regexp = "alpha level -1 not in"
  )
  ...
  # Reverse also with alpha
  expect_error(p + scale_colour_cross_blended_b(direction = 0.5),
    regexp = "must be 1 or -1"
  )
...
test_that("Breaking scale tint", {
  ...
  # Use tint option
  expect_error(p + scale_colour_cross_blended_tint_b(palette = "x"))
  expect_error(p + scale_colour_cross_blended_tint_b(palette = "x"))
  expect_error(p + scale_colour_cross_blended_tint_b(alpha = -1))
  expect_error(p + scale_colour_cross_blended_tint_b(direction = -12))
