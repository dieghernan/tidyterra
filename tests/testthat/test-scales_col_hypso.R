test_that("Discrete scale", {
  ...
  # Alpha
  expect_snapshot(p + scale_colour_hypso_d(alpha = -1),
    error = TRUE
  )
  ...
  expect_snapshot(p + scale_colour_hypso_d(direction = 0.5),
    error = TRUE
  )
...
test_that("Discrete scale tint", {
  ...
  expect_snapshot(p + scale_colour_hypso_tint_d(direction = -12), error = TRUE)
...
test_that("Continous scale", {
  ...
  # Alpha
  expect_snapshot(p + scale_colour_hypso_c(alpha = -1),
    error = TRUE
  )
  ...
  # Reverse also with alpha
  expect_snapshot(p + scale_color_hypso_c(direction = 0.5),
    error = TRUE
  )
...
test_that("Continous scale tint", {
  ...
  # Use tint option
  expect_snapshot(p + scale_colour_hypso_tint_c(palette = "x"), error = TRUE)
  expect_snapshot(p + scale_colour_hypso_tint_c(alpha = -1), error = TRUE)
  expect_snapshot(p + scale_colour_hypso_tint_c(direction = -12), error = TRUE)
...
test_that("Breaking scale", {
  ...
  # Alpha
  expect_snapshot(p_init + scale_colour_hypso_b(alpha = -1),
    error = TRUE
  )
  ...
  # Reverse also with alpha
  expect_snapshot(p + scale_colour_hypso_b(direction = 0.5),
    error = TRUE
  )
...
test_that("Breaking scale tint", {
  ...
  # Use tint option
  expect_snapshot(p + scale_colour_hypso_tint_b(palette = "x"), error = TRUE)
  expect_snapshot(p + scale_colour_hypso_tint_b(palette = "x"), error = TRUE)
  expect_snapshot(p + scale_colour_hypso_tint_b(alpha = -1), error = TRUE)
  expect_snapshot(p + scale_colour_hypso_tint_b(direction = -12), error = TRUE)
