test_that("Slice", {
  ...
  expect_message(compare_spatrasters(r, sliced), regexp = "extent")
...
test_that("Slice min", {
  ...
  # Keep extent
  sliced <- slice_min(r, log, n = 20, .keep_extent = TRUE, with_ties = FALSE)
...
test_that("Slice max", {
  ...
  # Keep extent
  sliced <- slice_max(r, log, n = 20, .keep_extent = TRUE, with_ties = FALSE)
