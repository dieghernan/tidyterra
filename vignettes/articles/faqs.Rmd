...
gganimate::animate(anim, duration = 12, rewind = TRUE)
```

```{r include_gif, echo=FALSE, out.width="50%", out.height="50%"}
knitr::include_graphics("chile_temp.gif")
```
...
plots. This section shows some demos.
