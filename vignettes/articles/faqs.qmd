...
**tidyterra** package and their answers, primarily focused on the
...
[^3]: The original file has been cropped, the numeric values have been converted
    to their corresponding labels and factors, and the corresponding color
    table added as described in
