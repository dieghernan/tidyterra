...
**tidyterra** package and their solutions, primarily focused on the
...
(i.e., `scale_fill_whitebox_c()`, etc.) have `na.value = "transparent"` by
default, which prevents `NA` values from being filled[^2].
