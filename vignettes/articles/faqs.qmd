...
questions](https://github.com/dieghernan/tidyterra/discussions) and answers
about using the **tidyterra** package, with a focus on the integration of
...
like the famous [Maungawhau / Mount
...
This is the default behavior of **ggplot2**. **tidyterra** color scales, for
example `scale_fill_whitebox_c()`, have `na.value = "transparent"` by default,
...
Use `geom_spatraster_rgb()` for the background tile, then add your data layers
on top:
