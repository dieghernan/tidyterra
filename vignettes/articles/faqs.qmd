...
**metR** package (see [Hexagonal grids and other geoms](#fort)). Use `bins`,
`binwidth` or `breaks` to align both labels and lines:
...
**ggplot2** invokes it implicitly when you use `ggplot(data = a_spatraster)`.
