...
```{r terr_wiki, echo=FALSE, fig.alt="Terrain and wiki palettes in tidyterra"}
...
```{r whitebox, echo=FALSE, fig.alt="Whitebox palettes in tidyterra"}
allpals <- sort(c(
  "atlas",
  "high_relief",
  "arid",
...
```{r hypso, echo=FALSE, fig.alt="Hypso palettes in tidyterra"}
...
```{r cross, echo=FALSE, fig.alt="Cross-blended palettes in tidyterra"}
...
```{r grass, echo=FALSE, fig.alt="GRASS palettes in tidyterra"}
...
```{r princess, echo=FALSE, fig.alt="Princess palettes in tidyterra"}
