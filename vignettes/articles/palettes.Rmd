...
Check `scale_fill_hypso_c()` for more info. These plots have been generated
using the option `as_tint = FALSE`.
...
Check `scale_cross_blended_hypso_c()` for more info. These plots have been
generated using the option `as_tint = FALSE`.
