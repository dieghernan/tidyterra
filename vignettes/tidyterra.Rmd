...
<div class="figure">
<img src="./spatraster-faceted-1.png" alt="Figure 1: Faceted map with multi-layer raster file." width="100%" />
<p class="caption">Figure 1: Faceted map with multi-layer raster file.</p>
</div>
...
<div class="figure">
<img src="./spatraster-modified-1.png" alt="Figure 2: Mapping a modified `SpatRaster` with an `SpatVector`" width="100%" />
<p class="caption">Figure 2: Mapping a modified `SpatRaster` with an `SpatVector`</p>
</div>
...
<div class="figure">
<img src="./spatvector-1.png" alt="Figure 3. Mapping a modified `SpatVector`" width="100%" />
<p class="caption">Figure 3. Mapping a modified `SpatVector`</p>
</div>
