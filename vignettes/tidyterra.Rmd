...
[^1]:
    The term `geoms` refers to geometric objects, and `stats` refers to
...
The **tidyverse** is designed to work with tidy data (_"every column is a
variable, every row is an observation, every cell is a single value"_),
