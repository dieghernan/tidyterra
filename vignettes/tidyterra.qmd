...
[@R-dplyr], **tidyr** [@R-tidyr] or **tibble** [@R-tibble]. This
makes spatial data manipulation and analysis easier and faster for users
already familiar with the **tidyverse**.
...
of `SpatRaster` objects with **ggplot2**, **tidyterra** functions provide
...
same CRS[^2] through `ggplot2::coord_sf()`. **tidyterra** also provides
...
-   Details on each function, including the equivalent **terra** function when
    available, in case users prefer to include those in their workflows.
