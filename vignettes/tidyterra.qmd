...
2022, and has been actively used by other packages, such as **ebvcube**
...
`terra::plot()` does), and you can override this upper limit with the geom's
`maxcell` argument.

Also note that, when possible, each **tidyterra** help page references its
equivalent **terra** function.
