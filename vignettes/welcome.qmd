...
`geom_spat*()` geoms for plotting them with
...
**tidyterra** lets users manipulate `Spat*` objects in a style similar to
...
<div class="figure">
<img src="./fig-faceted-1.png" alt="A faceted map using a SpatRaster." width="100%" />
<p class="caption">A faceted map using a SpatRaster.</p>
</div>
...
<div class="figure">
<img src="./fig-rgb-1.png" alt="A map combining an RGB SpatRaster and a SpatVector." width="100%" />
<p class="caption">A map combining an RGB SpatRaster and a SpatVector.</p>
</div>
