...
**tidyverse** verbs, especially **dplyr** and **tidyr** methods,
**tidyterra** lets users manipulate `Spat*` objects in a style familiar from
...
rows, columns, extent, resolution and CRS) remain unchanged. Other verbs
